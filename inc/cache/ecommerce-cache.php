...
defined('ABSPATH') or exit('Not allow!');
...
class Breeze_Ecommerce_Cache {
    public function __construct() {
        add_action('activated_plugin', [$this, 'detect_ecommerce_activation']);
        add_action('deactivated_plugin', [$this, 'detect_ecommerce_deactivation']);
        add_action('wp_loaded', [$this, 'update_ecommerce_activation']);
    }
        ...
        if (function_exists('give_get_settings') && defined('GIVE_VERSION')) {
            ...
            if (!empty($give_shop_settings)) {
                ...
                if (!empty($urls)) {
                    ...
                    $urls = array_map([$this, 'rtrim_urls'], $urls);
                }
            }
        }
    ...
    public function get_translate_urls($urls, $postID, $regex = null) {
        ...
        if (class_exists('TRP_Translate_Press')) {
            ...
            foreach ($other_languages as $code => $name) {
                ...
                if ($url_converter->get_lang_from_url_string($page_link) === null) {
