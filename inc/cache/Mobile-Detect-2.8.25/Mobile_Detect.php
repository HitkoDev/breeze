 ...
 *
 * @see        Homepage:     http://mobiledetect.net
...
class Mobile_Detect {
    ...
    public function setUserAgent($userAgent = null) {
        ...
        foreach ($this->getUaHttpHeaders() as $altHeader) {
            if (empty($this->httpHeaders[$altHeader]) === false) { // @todo: should use getHttpHeader(), but it would be slow. (Serban)
    ...
    public function match($regex, $userAgent = null) {
        $match = (bool) preg_match(sprintf('#%s#is', $regex), (empty($userAgent) === false ? $userAgent : $this->userAgent), $matches);
     ...
     *
     * @return float|string The version of the property we are trying to extract.
     */
