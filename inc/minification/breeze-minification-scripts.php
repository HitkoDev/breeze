...
class Breeze_MinificationScripts extends Breeze_MinificationBase {
    ...
    private $custom_js_exclude = [];
    private $js_head_group = [];
    private $js_footer_group = [];
    private $js_min_head = [];
    private $js_min_footer = [];
    private $url_group_head = [];
    private $url_group_footer = [];
    private $jscode_inline_head = [];
    private $jscode_inline_footer = [];
    private $move_to_footer_js = [];
    private $move_to_footer = [];
    private $defer_js = [];
    private $full_script = '';
    private $uncompressed_inline = [];
