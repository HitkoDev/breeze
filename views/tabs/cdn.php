...
<table cellspacing="15">
    <tr>
        <td>
            <label for="activate-cdn"
                class="breeze_tool_tip"><?php _e('Activate CDN', 'breeze'); ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="activate-cdn"
                name="activate-cdn"
                value="1"
                <?php checked($cdn_integration['cdn-active'], '1'); ?>/>
    ...
    <tr>
        <td>
            <label for="cdn-url"
                class="breeze_tool_tip"><?php _e('CDN CNAME', 'breeze'); ?></label>
        </td>
        <td>
            <?php
            ...
            <input type="text"
                ...
                name="cdn-url"
                size="50"
                placeholder="<?php _e('https://www.domain.com', 'breeze'); ?>"
                value="<?php echo $cdn_url; ?>" />
            <span style="vertical-align: baseline"
                class="breeze_tool_tip"><?php _e('Enter CDN CNAME.', 'breeze'); ?></span>
            <br>
    ...
    <tr>
        <td>
            <label for="cdn-content"
                class="breeze_tool_tip"><?php _e('CDN Content', 'breeze'); ?></label>
        </td>
        <td>
            <input type="text"
                id="cdn-content"
    ...
    <tr>
        <td>
            <label for="cdn-exclude-content"
                class="breeze_tool_tip"><?php _e('Exclude Content', 'breeze'); ?></label>
        </td>
        <td>
            <input type="text"
                id="cdn-exclude-content"
                name="cdn-exclude-content"
                size="50"
    ...
    <tr>
        <td>
            <label for="cdn-relative-path"
                class="breeze_tool_tip"><?php _e('Relative path', 'breeze'); ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="cdn-relative-path"
                name="cdn-relative-path"
                value="1"
                <?php checked($cdn_integration['cdn-relative-path'], '1'); ?>/>
