...
<div class="breeze-top-notice">
    <p class="breeze_tool_tip"><?php _e('Important: Backup your databases before using the following options!', 'breeze'); ?>
    </p>
</div>
<table cellspacing="15">
    <tr>
        <td>
            <label for="data0"
                class="breeze_tool_tip"><?php _e('Select all', 'breeze'); ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data0"
    ...
    <tr>
        <td>
            <label for="data1"
                class="breeze_tool_tip"><?php _e('Post revisions', 'breeze'); ?><?php echo '&nbsp(' . $post_revisions . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data1"
    ...
    <tr>
        <td>
            <label for="data2"
                class="breeze_tool_tip"><?php _e('Auto drafted content', 'breeze'); ?><?php echo '&nbsp(' . $drafted . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data2"
    ...
    <tr>
        <td>
            <label for="data3"
                class="breeze_tool_tip"><?php _e('All trashed content', 'breeze'); ?><?php echo '&nbsp(' . $trashed . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data3"
    ...
    <tr>
        <td>
            <label for="data4"
                class="breeze_tool_tip"><?php _e('Comments from trash & spam', 'breeze'); ?><?php echo '&nbsp(' . $comments . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data4"
    ...
    <tr>
        <td>
            <label for="data5"
                class="breeze_tool_tip"><?php _e('Trackbacks and pingbacks', 'breeze'); ?><?php echo '&nbsp(' . $trackbacks . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data5"
    ...
    <tr>
        <td>
            <label for="data6"
                class="breeze_tool_tip"><?php _e('Transient options', 'breeze'); ?><?php echo '&nbsp(' . $transients . ')'; ?></label>
        </td>
        <td>
            <input type="checkbox"
                id="data6"
    ...
    <tr>
        ...
        <td>
            <input type="submit"
                id="breeze-database-optimize"
                class="button button-primary"
                <?php echo $is_optimize_disabled ? ' disabled="disabled"' : ''; ?> value="<?php esc_attr_e('Optimize'); ?>">
        </td>
    </tr>
</table>
