...
<table cellspacing="15"
    ...
    <tr>
        <td><label for="bz-lazy-load"
                class="breeze_tool_tip"><?php _e('Lazy-Load images', 'breeze'); ?></label></td>
        <td>
            <?php
            $disabled = 'disabled';
            ...
            <input type="checkbox"
                ...
                name="bz-lazy-load"
                value='1'
                <?php checked($advanced['breeze-lazy-load'], '1'); ?> <?php echo $disabled; ?>/>
            ...
            <span <?php echo $hide; ?> id="native-lazy-option">
                <input type="checkbox"
                    id="bz-lazy-load-nat"
                    name="bz-lazy-load-nat"
                    value='1'
                    <?php checked($advanced['breeze-lazy-load-native'], '1'); ?>/>
                <span class="breeze_tool_tip">
    ...
    <tr>
        <td>
            <label for="exclude-urls"
                class="breeze_tool_tip"><?php _e('Never Cache these URLs', 'breeze'); ?></label>
        </td>
        <td>
            <?php
            $css_output = '';
            ...
            <textarea cols="100"
                rows="7"
                id="exclude-urls"
                name="exclude-urls"><?php echo $css_output; ?></textarea>
            <br />
            <span class="breeze_tool_tip"><b>Note:&nbsp;</b><?php _e('Add the URLs of the pages (one per line) you wish to exclude from the WordPress internal cache. To exclude URLs from the Varnish cache, please refer to this ', 'breeze'); ?><a href="https://support.cloudways.com/how-to-exclude-url-from-varnish/"
                    target="_blank"><?php _e('Knowledge Base', 'breeze'); ?></a><?php _e(' article.', 'breeze'); ?> </span>
            <?php if ($excluded_url_list === false) { ?>
            <br />
            <span class="breeze_tool_tip"
                style="color: #ff0000">
            ...
            <ul>
                <li>
                    <input type="checkbox"
                        ...
                        id="group-css"
                        value="1"
                        <?php checked($advanced['breeze-group-css'], '1'); ?>/>
                    <label class="breeze_tool_tip"
                        for="group-css"><?php _e('CSS', 'breeze'); ?></label>
                </li>
                <li>
                    <input type="checkbox"
                        name="group-js"
                        id="group-js"
                        value="1"
                        <?php checked($advanced['breeze-group-js'], '1'); ?>/>
                    <label class="breeze_tool_tip"
                        for="group-js"><?php _e('JS', 'breeze'); ?></label>
                </li>
                <li>
                    <span class="breeze_tool_tip">
    ...
    <tr>
        ...
        <td>
            <input type="checkbox"
                ...
                id="preload-links"
                value="1"
                <?php checked($advanced['breeze-preload-links'], '1'); ?>/>
            <label class="breeze_tool_tip"
                for="preload-links"><?php _e('Activate preload links feature', 'breeze'); ?></label>
            <br />
            <span class="breeze_tool_tip">
    ...
    <tr>
        <td>
            <label for="exclude-css"
                class="breeze_tool_tip"><?php _e('Exclude CSS', 'breeze'); ?></label>
        </td>
        <td>
            <?php
            $css_output = '';
            ...
            <textarea cols="100"
                rows="7"
                id="exclude-css"
                name="exclude-css"><?php echo $css_output; ?></textarea>
            <?php if ($excluded_css_check_extension === false) { ?>
            ...
            <?php } ?>
            <?php if ($excluded_css_check === false) { ?>
            <br /><span class="breeze_tool_tip"
                style="color: #ff0000"><?php _e('One (or more) URL is invalid. Please check and correct the entry.', 'breeze'); ?></span>
            <?php } ?>
            <br />
    ...
    <tr>
        <td>
            <label for="exclude-js"
                class="breeze_tool_tip"><?php _e('Exclude JS', 'breeze'); ?></label>
        </td>
        <td>
            <?php
            $js_output = '';
    ...
    <tr>
        <td>
            <label for="breeze-preload-font"
                class="breeze_tool_tip"><?php _e('Preload your webfonts', 'breeze'); ?></label>
        </td>
        <td>
            <div class="breeze-list-url">
                ...
                <div class="breeze-input-group">
                    ...
                    <span class="dashicons dashicons-no item-remove"
                        title="<?php _e('Remove', 'breeze'); ?>"></span>
                </div>
                <?php } ?>
                <?php } else { ?>
                <div class="breeze-input-group">
            ...
            <div style="margin: 10px 0">
                <button type="button"
                    class="button add-url"
                    id="add-breeze-preload-fonts">
    ...
    <tr>
        <td>
            <label for="move-to-footer-js"
                class="breeze_tool_tip"><?php _e('Move JS files to footer', 'breeze'); ?></label>
        </td>
        <td>
            <div class="breeze-list-url">
    ...
    <tr>
        <td>
            <label for="defer-js"
                class="breeze_tool_tip"><?php _e('JS files with deferred loading', 'breeze'); ?></label>
        </td>
        <td>
            <div class="breeze-list-url">
    ...
    <tr>
        <td>
            <label for="delay-js-scripts"
                class="breeze_tool_tip"><?php _e('Delay JS inline scripts', 'breeze'); ?></label>
        </td>
        <td>
            <input type="checkbox"
                name="enable-js-delay"
                id="enable-js-delay"
                value="1"
                <?php checked($advanced['breeze-enable-js-delay'], '1'); ?>/>
            <label class="breeze_tool_tip"
                for="enable-js-delay"><?php _e('Enable delay inline JavaScript', 'breeze'); ?></label>
            <br />
            <br />
            <?php
            $js_output = '';
            ...
            <div <?php echo $display_text_area; ?> id="breeze-delay-js-scripts-div">
                <textarea cols="100"
                    rows="7"
                    id="delay-js-scripts"
                    name="delay-js-scripts"><?php echo $js_output; ?></textarea>
                <br />
                <span class="breeze_tool_tip">
                    ...
                    <a href="https://www.cloudways.com/blog/breeze-1-2-version-released/"
                        target="_blank"><?php _e('More info here', 'breeze'); ?></a><br />
