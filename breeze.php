...
register_activation_hook(__FILE__, ['Breeze_Admin', 'plugin_active_hook']);
//Deactivate plugin hook
register_deactivation_hook(__FILE__, ['Breeze_Admin', 'plugin_deactive_hook']);
